        ...
        <div className="container py-1 pb-1 ">
          <div className="flex items-center justify-center gap-5">
            ...
            <div className="col flex items-center justify-center flex-col group w-[20%]">
              ...
              <p className='md:text-[13px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)]'>For all Orders Over $100</p>
            </div>
            ...
            <div className="col flex items-center justify-center flex-col group w-[20%]">
              ...
              <p className='md:text-[13px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)]'>For an Exchange Product</p>
            </div>
            ...
            <div className="col flex items-center justify-center flex-col group w-[20%]">
              ...
              <p className='md:text-[13px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)]'>Payment Cards Accepted</p>
            </div>
            ...
            <div className="col flex items-center justify-center flex-col group w-[20%]">
              ...
              <p className='md:text-[13px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)]'>Our First Product Order</p>
            </div>
            ...
            <div className="col flex items-center justify-center flex-col group w-[20%]">
              ...
              <p className='md:text-[13px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)]'>Contact us Anytime</p>
            </div>
          ...
          <div className="footer flex py-1 mt-16">
            <div className="part1 w-[30%] border-r-2 border-[#f1f1f1]">
              <h2 className='md:text-[20px] text-[14px] font-[600] '>Contact us</h2>
              <p className='md:text-[15px] text-[10px] font-[400] text-[rgba(0,0,0,0.8)] py-5'>
                BlinkBasket - Bhayandar, Navghar Naka,<br /> Bhayandar East, Mira Bhayandar,<br /> Maharashtra 401105
              </p>
              <p>

              <Link to="mailto:svish5633@gmail.com" className="link text-[rgba(0,0,0,0.8)] md:text-[16px] text-[10px]">svish5633@gmail.com</Link>
              </p>

              <span className='md:text-[22px] text-[10px] font-[500] text-[#ff5252] block py-3'>(+91) 9022642653</span>


              <div className="flex items-center gap-3 py-4">
                <IoChatboxEllipsesOutline className='text-[55px] text-[#ff5252]' />
                <span className='md:text-[17px] text-[10px] font-[500] '>
                  Online Chat<br />
                  Get Expert Help
                </span>
              </div>
            ...
            <div className="part2 flex w-[70%] md:pl-12 pl-2">
              ...
              <div className="part2_col3 w-[70%]">
                <h2 className='md:text-[20px] text-[14px] font-[600] mb-4'>Subscribe to newsletter</h2>

                <p className='text-[rgba(0,0,0,0.8)] md:text-[15px] text-[10px]'>Subscribe to our latest newsletter to get news<br /> about special discounts.</p>

                <form action="post" className='mt-5'>
                  <input type="text" className='w-full md:h-[45px] h-[35px] text-[10px] border outline-none pl-[12px] pr-[10px] rounded-md mb-4 focus:border-[rgba(0,0,0,0.3)]' placeholder='Your Email Address' />

                  <Button className='!bg-[#ff5656] !text-white md:!text-[12px] md:!py-[7px] md:!px-[14px] !text-[10px] hover:!bg-[#e73c3c] transition-all'>SUBSCRIBE</Button>
